 ...
 * @author ADmin
 */
public class SuaLoaiSanPhamGUI extends javax.swing.JFrame {

    /**
     * Creates new form SuaLoaiSanPhamGUI
     */
    ...
    public SuaLoaiSanPhamGUI(LoaiSanPhamGUI root) {
        initComponents();
        this.root = root;
    ...
    private void initComponents() {
        ...
        jLabel2.setText("SỬA LOẠI SẢN PHẨM");
    ...
    private void hoanTatButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hoanTatButtonActionPerformed
        if (tenLoaiTextField.getText().equals("")) {
            ...
            Vector data = getNewData();
            root.updateNewRow(data, rowIsSelected);
            dispose();
    ...
    public void run(Vector data, int rowIsSelected) {
        this.data = data;
        this.rowIsSelected = rowIsSelected;
        loadData();
        root.updateNewRow(data, rowIsSelected);
    ...
    private void loadData() {
        tenLoaiTextField.setText(data.get(1).toString());
    }
    
    private Vector getNewData() {
        Vector newData = new Vector();
        newData.add("");
        newData.add(tenLoaiTextField.getText());
        return newData;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaLoaiSanPhamGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuaLoaiSanPhamGUI().setVisible(true);
            }
        });
    }

 ...
 * @author ADmin
 */
public class ThemNhaCungCapGUI extends javax.swing.JFrame {
    
    
    private NhaCungCapGUI root;

    /**
     * Creates new form ThemNhaCungCapGUI
     */
    ...
    private void initComponents() {
        ...
        titleLabel.setText("THÊM NHÀ CUNG CẤP");
    ...
    public void run(NhaCungCapGUI root) {
        this.root = root;
        clearData();
        setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemNhaCungCapGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemNhaCungCapGUI().setVisible(true);
            }
        });
    }

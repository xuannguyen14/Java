 ...
 * @author ADmin
 */
public class ThemNhaSanXuatGUI extends javax.swing.JFrame {
    
    private NhaSanXuatGUI root;

    /**
     * Creates new form ThemNhaSanXuatGUI
     */
    public ThemNhaSanXuatGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        titleLabel.setText("THÊM NHÀ SẢN XUẤT");
    ...
    public void clearData() {
        tenNSXTextField.setText("");
        diaChiTextfield.setText("");
        SDTTextfield.setText("");
    }
    
    public void run(NhaSanXuatGUI root) {
        this.root = root;
        clearData();
        setVisible(true);
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemNhaSanXuatGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemNhaSanXuatGUI().setVisible(true);
            }
        });
    }

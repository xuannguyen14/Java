 ...
 * @author ADmin
 */
public class SuaNhaCungCapGUI extends javax.swing.JFrame {
    
    private NhaCungCapGUI root;
    private Vector data;
    private int rowIsSelected;

    /**
     * Creates new form SuaNhaCungCapGUI
     */
    ...
    private void initComponents() {
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(tenNCCTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 492, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addComponent(tenNCCTextField, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(19, 19, 19)
        ...
        titleLabel.setText("SỬA NHÀ CUNG CẤP");
    ...
    private void hoanTatButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_hoanTatButtonActionPerformed
        // TODO add your handling code here:
        if (tenNCCTextField.getText().length() == 0 || diaChiTextfield.getText().length() == 0 || SDTTextfield.getText().length() == 0) {
    ...
    public void loadData() {
        tenNCCTextField.setText(data.get(1).toString());
        diaChiTextfield.setText(data.get(2).toString());
        SDTTextfield.setText(data.get(3).toString());
    }
    
    public void run(NhaCungCapGUI root, Vector data, int rowIsSelected) {
        this.root = root;
        this.data = data;
    ...
    public Vector getData() {
        ...
        data.add("");
        data.add(tenNCCTextField.getText());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SuaNhaCungCapGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SuaNhaCungCapGUI().setVisible(true);
            }
        });
    }
